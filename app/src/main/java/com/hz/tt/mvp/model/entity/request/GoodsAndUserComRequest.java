...
public class GoodsAndUserComRequest {
    private GoodsAndUserCommentBean bean;
    public GoodsAndUserComRequest(GoodsAndUserCommentBean bean) {
        this.bean=bean;
    }
    public String getUrl() {
        Gson gson=new Gson();
        String meth = "WINECELLAR_QUERY_CODE_USER"/*typeMeg*/;
